...
SELECT 
    '/b_orga_dept_members/orga_dept_member_archive_delete_0.sql?orga_dept_id='||$orga_dept_id AS link,
    'alert-circle'                              AS icon,
    'Je confirme la suppression'                AS title,
    'red'                                       AS color;

SELECT 
    '/b_orga_dept_members/orga_dept_member_archive_anonym_0.sql?orga_dept_id='||$orga_dept_id AS link,
