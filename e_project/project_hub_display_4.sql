...
SELECT 
    ...
    TRUE                  AS sort, 
    '/e_project_workpackage/workpackage_main_edit_4.sql?workpackage_id={id}' as edit_url,
    '/e_project_workpackage/workpackage_main_delete_alert_4.sql?workpackage_id={id}' as delete_url,
    'Hub'                AS markdown,
    FALSE                 AS search;

SELECT
    workpackage_id            AS Id,
    workpackage_id            AS _sqlpage_id,
