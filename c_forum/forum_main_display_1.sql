...
SELECT 
    ...
    'L'     AS size;
SELECT 
    '/c_forum/forum_main_form_1.sql'     AS link,
    'green'                              AS color,
    TRUE                                 AS important,
...
SELECT 'table' AS component, 
    ...
    JSON('{"name":"Discussion","tooltip":"Entrer dans a discussion","link":"/c_forum/forum_message_display_1.sql?topic_id={id}","icon":"messages"}') as custom_actions,
    TRUE             AS sort, 
    TRUE             AS search;
