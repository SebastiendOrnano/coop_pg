...
'/c_forum/forum_message_close_display_5.sql?topic_id='||$topic_id AS link 
...
SELECT 
    'table'                      AS component, 
    'Message'                    AS markdown,
    '/c_forum/forum_message_edit_5.sql?message_id={id}' as edit_url,
    '/c_forum/forum_message_delete_0.sql?message_id={id}' as delete_url,
    TRUE                         AS sort, 
    TRUE                         AS search;

SELECT
    message_id             AS Id,
    message_id             AS _sqlpage_id,
    to_char(created_at AT TIME ZONE 'Europe/Paris', 'YYYY-MM-DD HH24:MI')             AS Created_at,
...
SELECT 'form'      AS component,
 'Envoyer'         AS validate,
 'Clear'           AS reset,
 '/c_forum/forum_message_create_0.sql?topic_id='||$topic_id AS action;

SELECT 
'message_content'                  AS name, 
'textarea'                         AS type, 
'Votre contribution'               AS label,
'Votre contribution'               AS value,
