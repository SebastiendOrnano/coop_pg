...
SELECT       -- NOTE: the dots join values FROM the forum_topics and forum_messages tables
   ...
   (SELECT username FROM users WHERE users.user_id =  topic_author_id)   AS Contributeur,
    '[Discussion](/c_forum/forum_message_display_5.sql?topic_id=' || t.topic_id ||  ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [Edit](/c_forum/forum_main_edit_5.sql?topic_id=' || t.topic_id ||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [Delete](/c_forum/forum_main_delete_alert1_5.sql?topic_id=' || t.topic_id ||')'    AS View
