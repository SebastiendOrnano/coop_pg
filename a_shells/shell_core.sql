...
SET orga_dept_name = (SELECT orga_dept_name FROM orga_dept WHERE orga_dept_master = 'master');

SET logo = (SELECT orga_dept_logo_url FROM orga_dept WHERE orga_dept_master = 'master');
