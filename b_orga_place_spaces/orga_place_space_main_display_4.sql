...
SELECT 
    ...
    'salles rattachées au lieu'   AS title;
...
SELECT 
    '/b_orga_place_spaces/orga_place_space_archive_display_4.sql?place_id='||$place_id     as link,
    'Visualiser les salles archivés'                     as description,
    'archive'                                          as icon,
    'green'                                            as color;
