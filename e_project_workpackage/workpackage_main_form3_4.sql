...
SET workpackage_parent_id = SELECT workpackage_id FROM project_workpackage WHERE workpackage_id=:workpackage_id::INTEGER;
SET workpackage_parent_date_start_scheduled = SELECT DATE(workpackage_date_start_scheduled) FROM project_workpackage WHERE workpackage_id=:workpackage_id::INTEGER;
SET workpackage_parent_duration_scheduled = SELECT workpackage_duration_scheduled FROM project_workpackage WHERE workpackage_id=:workpackage_id::INTEGER;
SET workpackage_child_date_start_scheduled = DATE($workpackage_parent_date_start_scheduled::DATE + $workpackage_parent_duration_scheduled::INTEGER);
