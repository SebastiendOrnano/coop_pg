...
SELECT 
    ...
    'Gestion des départements archivés de l''organisation' AS title;
...
SELECT 
    ...
    TRUE                  AS sort, 
    JSON('{"name":"Employees","tooltip":"Employés","link":"/b_orga_dept/orga_dept_member_display_4.sql?orga_dept_id={id}","icon":"users"}') as custom_actions,
