...
SELECT 
    ...
    '/e_project_workpackage_stats/stat_workpackage_workhours_participant2_csv_0.sql?workpackage_id='||$workpackage_id AS action;
...
SELECT 
   'prm2_sub_id' as name,
    ...
    LEFT JOIN (SELECT worksequence_id  FROM project_worksequence) as s
