...
SELECT 'Valorisation des déchets de la tranche de travaux:  '||$waste_value||' euros' AS contents_md

SELECT 
    'chart'             AS component,
    'pie'               AS type,
    'green'             AS color,
    'Répartition des déchets par type' AS title,
    TRUE                AS labels;
SELECT 
...
SELECT 
    ...
    'pie'               AS type,
    'green'             AS color,
    'Valeur des déchets par type  de destination' AS title,
    TRUE                AS labels;
