...
SET project_meeting_participant_id= SELECT project_meeting_participant_id FROM project_meeting_participants WHERE user_id=$user_id::INTEGER and project_meeting_id=$project_meeting_id::INTEGER;
