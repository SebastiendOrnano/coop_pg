...
SELECT
    ...
    THEN m.prm1_email
    END                                    AS Mail,
    '[remove](/e_project_meeting/project_meeting_participant_remove_0.sql?project_meeting_participant_id='||p.project_meeting_participant_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[change role](/e_project_meeting/project_meeting_participant_edit_4.sql?project_meeting_participant_id='||p.project_meeting_participant_id||')'  AS view
