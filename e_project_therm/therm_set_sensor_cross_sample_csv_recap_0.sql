...
(
    ...
    AND ts BETWEEN $sample_period_start::timestamp AND $sample_period_end::timestamp
    GROUP BY ts
),
params AS
(
...
'"Debut mesures"' as sample_period_start,
'"Fin mesures"' as sample_period_end,
...
SELECT
    ...
    $sample_period_start::timestamp as sample_period_start,
    $sample_period_end::timestamp as sample_period_end,
...
(
    ...
    AND (therm_data_date + therm_data_hour)::timestamp BETWEEN $sample_period_start::timestamp  AND $sample_period_end::timestamp
