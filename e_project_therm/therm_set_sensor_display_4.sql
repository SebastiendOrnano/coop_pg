...
SELECT 
    '/e_project_therm/therm_set_sensor_form_4.sql?therm_set_id='||$therm_set_id      as link,
...
SELECT 
    ...
    'Comparer les mesures de 2 capteurs'                        as description,
    'arrows-cross'                                           as icon,
    'blue'                                                 as color;

SELECT 
     '/e_project_therm/therm_set_sensor_archive_4.sql?therm_set_id='||$therm_set_id      as link,
    'Visualiser les capteurs archivés'           as description,
    'archive'                                     as icon,
    'green'                                              as color;
