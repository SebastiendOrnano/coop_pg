...
SELECT 
    '/e_project_therm/therm_data_delete_0.sql?therm_data_id='||$therm_data_id       as link,
    'Suppression' as title;
SELECT 
    '/e_project_therm/therm_data_display_4.sql?therm_dataset_id='||$therm_dataset_id    as link,
