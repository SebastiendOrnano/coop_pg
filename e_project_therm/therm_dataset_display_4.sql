...
SELECT 
    '/e_project_therm/therm_dataset_form_4.sql?therm_set_sensor_id='||$therm_set_sensor_id      as link,
    'créer un jeu de données'                  as description,
    'table_share'                                      as icon,
    'yellow'                                         as color;
SELECT 
    '/e_project_therm/therm_dual_dataset_analysis_step1_4.sql?therm_set_sensor_id='||$therm_set_sensor_id      as link,
    'Analyse croisée 2 dataset'                  as description,
    'arrows-double-ne-sw'                                      as icon,
    'blue'                                         as color;
SELECT 
     '/e_project_therm/therm_dataset_archive_4.sql?therm_set_sensor_id='||$therm_set_sensor_id      as link,
    'Visualiser les jeux de données archivés'           as description,
    'archive'                                     as icon,
    'green'                                              as color;
