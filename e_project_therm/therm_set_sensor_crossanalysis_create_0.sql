...
INSERT INTO therm_crossanalysis (
    ...
    dataset2_date_start,
    dataset2_date_end ,
    crossanalysis_period_start,
    crossanalysis_period_end
)
VALUES (
    ...
    $dataset1_date_start::timestamp,
    $dataset1_date_end::timestamp,
    $dataset2_date_start::timestamp,
    $dataset2_date_end::timestamp,
    $crossanalysis_period_start::timestamp,
    $crossanalysis_period_end::timestamp
);

SET crossanalysis_id = (SELECT MAX(crossanalysis_id) FROM therm_crossanalysis WHERE therm_set_id=$therm_set_id::INTEGER);
