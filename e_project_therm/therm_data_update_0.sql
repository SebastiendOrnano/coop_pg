...
UPDATE therm_data 
SET
  therm_data_temp=COALESCE(NULLIF(:therm_data_temp, ''), NULL)::float4,
  therm_data_rh=COALESCE(NULLIF(:therm_data_rh, ''), NULL)::numeric(3,1),
  therm_data_co2=COALESCE(NULLIF(:therm_data_co2, ''), NULL)::numeric(10,2),
  therm_data_hour=COALESCE(NULLIF(:therm_data_hour, ''), NULL)::time,
  therm_data_date=COALESCE(NULLIF(:therm_data_date, ''), NULL)::date,
  updated_at = CURRENT_TIMESTAMP
WHERE therm_data_id = $therm_data_id::INTEGER
