...
SELECT 
    ...
    'red'                                   AS color;
SELECT 
    '/e_project_docs/project_doc_select_edit_4.sql?project_id='||$project_id     AS link,
    'Actualiser des données sur les doc sélectionnés'       AS description,
    'refresh'                                  AS icon,
    'blue'                                   AS color;
SELECT 
    '/e_project_docs/project_doc_select_delete_0.sql?project_id='||$project_id     AS link,
