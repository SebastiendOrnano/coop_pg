...
SELECT
   ...
   '[View & Partcipants](/b_events/event_poster_4.sql?event_id=' || e.event_id || ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Edit](/b_events/event_main_edit_4.sql?event_id=' || e.event_id || ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Delete](/b_events/event_main_delete_alert_4.sql?event_id=' || e.event_id|| ')'    AS View
FROM events AS e
