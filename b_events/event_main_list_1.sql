...
',event_summary
    ...
    '/b_events/event_poster_1.sql?event_id='||e.event_id    AS link,
    '/b_events/event_poster_1.sql?event_id='||e.event_id    AS view_link
    FROM events AS e
    ...
    WHERE  e.event_name IS NOT NULL AND e.event_status ='active' AND e.event_public_private ='private' AND e.event_date > CURRENT_DATE;