...
SELECT
    ...
    'Actualisation des dates du lot de travaux' as title,
    'Close' as close,
    TRUE as large;

SELECT 
    'chart_modal1'            AS component,
...
SELECT 
   ...
   '/e_project_workpackage/workpackage_date_edit_4.sql?workpackage_id='||w.workpackage_id as link1,
   '/e_project_workpackage/workpackage_main_edit_4.sql?workpackage_id='||w.workpackage_id as link2,
