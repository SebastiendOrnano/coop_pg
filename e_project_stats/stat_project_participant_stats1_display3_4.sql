SELECT 
    ...
    'pie'               AS type,
    TRUE                AS horizontal,
    'Répartition prévue des temps de travail par type d''intervenant' AS title,
    'green'             AS color,
    TRUE                AS labels;
SELECT 
    ...
    LEFT JOIN (SELECT worksequence_id,workpackage_id, worksequence_name, worksequence_end_hour_scheduled, worksequence_start_hour_scheduled,worksequence_nb_participants FROM project_worksequence) AS s 
