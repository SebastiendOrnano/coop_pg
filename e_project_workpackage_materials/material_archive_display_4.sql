...
SELECT
    ...
    JSON('{"name":"Delete","tooltip":"Supprimer une dépense","link":"/e_project_workpackage_materials/material_main_delete_alert_4.sql?material_id='||m.material_id||'","icon":"trash"}') as _sqlpage_actions
