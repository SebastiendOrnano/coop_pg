...
SELECT
    ...
    '[Edit](/e_project_worksequence_participants/worksequence_participant_main_edit_4.sql?worksequence_participant_id='||p.worksequence_participant_id||') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Archive](/e_project_worksequence_participants/worksequence_participant_main_archive_0.sql?worksequence_participant_id='||p.worksequence_participant_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Remove](/e_project_worksequence_participants/worksequence_participant_main_remove_0.sql?worksequence_participant_id='||p.worksequence_participant_id||')'    AS View
