...
SET nb_employees_selected = SELECT COUNT(*) FROM prm2_sub_employees  WHERE employee_selected=true AND prm2_sub_id = $prm2_sub_id::INTEGER;
...
DELETE FROM prm1
SElECT p.prm1_id FROM  prm1 as p
...
SElECT prm1_doc_id FROM  prm1_doc as d
