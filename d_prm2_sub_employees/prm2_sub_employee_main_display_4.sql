...
SELECT
   ...
   '[View](/d_prm2_sub_employees/prm2_sub_employee_profile_display_4.sql?employee_id='||e.employee_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Edit](/d_prm2_sub_employees/prm2_sub_employee_main_edit_alert1_4.sql?employee_id='||e.employee_id||') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [Delete](/d_prm2_sub_employees/prm2_sub_employee_main_delete_alert1_4.sql?employee_id=' || e.employee_id ||') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [Remove](/d_prm2_sub_employees/prm2_sub_employee_main_remove_0.sql?employee_id=' || e.employee_id ||')'    AS View
FROM prm1 as p
