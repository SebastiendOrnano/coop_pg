...
SELECT
   ...
   '[View](/d_prm2_sub_employees/prm2_sub_employee_profile_display_3.sql?employee_id='||e.employee_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Edit](/d_prm2_sub_employees/prm2_sub_employee_main_edit_alert1_3.sql?employee_id='||e.employee_id||')'    AS View
FROM prm1 as p
