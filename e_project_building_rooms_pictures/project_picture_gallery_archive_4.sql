...
SELECT 
    '/e_project_building_rooms_pictures/project_picture_gallery_form1_4.sql?project_id='||$project_id     AS link,
    'Chercher une image par bâtiment'                            AS description,
    'photo-search'                                               AS icon,
    'yellow'                                                     AS color;
SELECT 
    '/e_project_building_rooms_pictures/project_picture_gallery_form2_4.sql?project_id='||$project_id     AS link,
    'Chercher une image par lot de travaux'                      AS description,
    'photo-search'                                               AS icon,
    'green'                                                      AS color;
SELECT 
    '/e_project_building_rooms_pictures/project_picture_gallery_form3_4.sql?project_id='||$project_id     AS link,
    'Chercher une image par son nom'                             AS description,
    'photo-search'                                               AS icon,
    'yellow'                                                      AS color;
SELECT 
    '/e_project_building_rooms_pictures/project_picture_gallery_archive_4.sql?project_id='||$project_id     AS link,
