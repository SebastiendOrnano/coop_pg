...
SELECT
    '![room_picture_url]('||room_picture_url||')' AS Img,
    room_picture_id            AS Id,
    room_picture_title            AS Nom,
    room_picture_format            AS Format,
'[View](room_picture_view_4.sql?room_picture_id='||room_picture_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[Edit](/e_project_building_rooms_pictures/room_picture_edit_4.sql?room_picture_id='||room_picture_id||')
