...
SET redirect_link =
CASE WHEN $user_role = 'supervisor' 
THEN  '/e_project_building_rooms_pictures/room_picture_display_4.sql?building_id='||$building_id
ELSE  '/e_project_building_rooms_pictures/room_picture_display_3.sql?building_id='||$building_id
END;*/
