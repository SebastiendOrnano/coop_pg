...
ELSE  '/e_project_workpackage_expenses/expense_main_display_4.sql?workpackage_id='||$workpackage_id
END;

DELETE FROM project_workpackage_expenses WHERE expense_id=$expense_id::INTEGER;
