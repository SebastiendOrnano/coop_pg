...
SELECT 'table' AS component, 
    ...
    'Titre'           AS markdown,
    '/b_orga_dept_doc/orga_dept_doc_main_edit_4.sql?orga_doc_id={id}' as edit_url,
    '/b_orga_dept_doc/orga_dept_doc_main_delete_alert1_4.sql?orga_doc_id={id}' as delete_url,
    TRUE             AS sort, 
    TRUE             AS search;
