...
SELECT 
    ...
    12 AS width,
    TRUE as required,
    (SELECT orga_dept_id FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
...
SELECT
    ...
    'text'                               as type,  
    'Titre'                              as label,
    (SELECT orga_doc_title  FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    TRUE                                as required,
    6                                   AS width;
...
SELECT
    ...
    'text'                    as type,  
    'Author'                  as label,
    (SELECT orga_doc_author  FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    6                        AS width;
...
SELECT 
    ...
    'textarea'             as type,
    'Résumé'               as label,
    (SELECT orga_doc_summary FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    12                     AS width;
...
SELECT 
    ...
    'text'                as type,
    'Mots clés'           as label,
    (SELECT orga_doc_keywords FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
 ...
 SELECT 
    ...
    'date'                      as type,
    (SELECT orga_doc_date_publication  FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    3                            AS width,
 ...
 SELECT 
    ...
    'text'                      as type,
    (SELECT orga_doc_date_period  FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    2                         AS width,
 ...
 SELECT 
    ...
    'select'                 as type,
    2                        AS width,
    (SELECT orga_doc_lang FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
 ...
 SELECT 
    ...
    'select'                 as type,
    2                       AS width,
   (SELECT orga_doc_format FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
...
SELECT 
    ...
    (SELECT orga_doc_number_page FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    3                     AS width;
...
SELECT 
    ...
    'select'                 as type,
    3                       AS width,
    (SELECT orga_doc_category FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
...
SELECT 
    ...
    'select'                  as type,
    (SELECT orga_doc_type FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
    3                         AS width,
...
SELECT 
    ...
    'select'                 as type,
    3                        AS width,
    (SELECT orga_doc_edition FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
...
SELECT 
    ...
    'select'                  as type,
    3                         AS width,
    (SELECT orga_doc_status FROM orga_docs WHERE orga_doc_id = $orga_doc_id::INTEGER ) as value,
