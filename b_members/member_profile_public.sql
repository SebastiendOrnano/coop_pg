...
SET since     = SELECT member_date_since FROM members WHERE member_id = $member_id::INTEGER;
SET function  = SELECT member_function FROM members WHERE member_id = $member_id::INTEGER;
...
SELECT 
    'text'              AS component,
    TRUE AS center,
    (SELECT member_punchline FROM members WHERE member_id = $member_id::INTEGER) AS title;
