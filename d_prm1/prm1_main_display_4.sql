...
SELECT 
    ...
    'Visualiser les personnes achivés'               as description,
    'archive'                                         as icon,
    'red'                                           as color;
...
SELECT 'table' AS component, 
    ...
    JSON('{"name":"View","tooltip":"Voir le profil","link":"/d_prm1/prm1_profile_display_4.sql?prm1_id={id}","icon":"user-circle"}') as custom_actions,
    JSON('{"name":"Doc","tooltip":"Documents liés à la personne","link":"/d_prm1_doc/prm1_doc_main_display_4.sql?prm1_id={id}","icon":"paperclip"}') as custom_actions,
    '/d_prm1/prm1_main_edit_4.sql?prm1_id={id}' as edit_url,
    '/d_prm1/prm1_main_delete_alert1_4.sql?prm1_id={id}' as delete_url,
