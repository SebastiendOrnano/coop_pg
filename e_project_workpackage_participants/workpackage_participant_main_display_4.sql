...
SELECT 
    'table'               AS component, 
    TRUE                  AS sort, 
    JSON('{"name":"Remove","tooltip":"Retirer le participant de la liste","link":"/e_project_workpackage_participants/workpackage_participant_main_remove_0.sql?workpackage_participant_id={id}","icon":"logout"}') as custom_actions,
    JSON('{"name":"Archive","tooltip":"Archiver le participant","link":"/e_project_workpackage_participants/workpackage_participant_main_archive_0.sql?workpackage_participant_id={id}","icon":"archive"}') as custom_actions,
