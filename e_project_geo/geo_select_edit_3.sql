...
SELECT 
    ...
    '/e_project_geo/geo_select_display_3.sql?geo_group_id='||$geo_group_id     AS link;

SELECT 
    'form' AS component,
    'Actualiser la description des éléments sélectionnées' AS title,
    'Mettre à jour' AS validate,
    'Clear' AS reset,
    '/e_project_geo/geo_select_update_0.sql?geo_group_id='||$geo_group_id  AS action;
