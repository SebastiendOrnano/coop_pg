...
-- Started on 2025-06-13 18:35:24 CEST
...
CREATE ROLE sebastien;
ALTER ROLE sebastien WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS;
...
-- Completed on 2025-06-13 18:35:24 CEST
...
SELECT pg_catalog.setval('public.info_sections_section_id_seq', 67, true);
...
SELECT pg_catalog.setval('public.sessions_session_id_seq', 474, true);
