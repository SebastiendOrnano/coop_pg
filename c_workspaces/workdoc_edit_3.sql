...
SELECT
    ...
    (SELECT workdoc_title FROM workdocs WHERE workdoc_id=$workdoc_id::INTEGER ) AS value,
...
SELECT
    ...
    'text' AS type,  
    'Author' AS label,
    (SELECT workdoc_author FROM workdocs WHERE workdoc_id=$workdoc_id::INTEGER ) AS value,
    6 AS width;
...
SELECT 
    ...
    'textarea' AS type,
    'Résumé' AS label,
    (SELECT workdoc_summary FROM workdocs WHERE workdoc_id=$workdoc_id::INTEGER) AS value,
    12 AS width;
 ...
 SELECT 
    ...
    'Statut'               AS label,
    'select'                AS type,
    (SELECT workdoc_status FROM workdocs WHERE  workdoc_id=$workdoc_id::INTEGER) AS value,
    2                       AS width,
...
SELECT 
    ...
    'text' AS type,
    (SELECT workdoc_version FROM workdocs WHERE  workdoc_id=$workdoc_id::INTEGER ) AS value,
 ...
 SELECT 
    ...
    'Langue'               AS label,
    'select'                AS type,
    (SELECT workdoc_lang FROM workdocs WHERE  workdoc_id=$workdoc_id::INTEGER) AS value,
    2                       AS width,
 ...
 SELECT 
    ...
    'Format'                 AS label,
    'select'                 AS type,
    (SELECT workdoc_format FROM workdocs WHERE workdoc_id=$workdoc_id::INTEGER ) AS value,
    2                       AS width,
...
SELECT 
    ...
    'Catégorie'                 AS label,
    'select'                 AS type,
    (SELECT workdoc_category FROM workdocs WHERE  workdoc_id=$workdoc_id::INTEGER) AS value,
    3                       AS width,
...
SELECT 
    ...
    'select'                  AS type,
    (SELECT workdoc_type FROM workdocs WHERE workdoc_id=$workdoc_id::INTEGER ) AS value,
    3                         AS width,
