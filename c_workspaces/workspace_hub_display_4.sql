...
SELECT 'table' AS component, 
    ...
    'Alert'          AS markdown,
    '/c_workspaces/workmeeting_edit_4.sql?workmeeting_id={id}' as edit_url,
    '/c_workspaces/workmeeting_delete_0.sql?workmeeting_id={id}' as delete_url,
    JSON('{"name":"View - Register","tooltip":"Voir et s''inscrire à la réunion","link":"/c_workspaces/workmeeting_participants_display_4.sql?workmeeting_id={id}","icon":"binoculars"}') as custom_actions,
    TRUE             AS sort, 
    TRUE             AS small,
    TRUE             AS search;
...
SELECT
    ...
    e.workmeeting_id               as _sqlpage_id,
