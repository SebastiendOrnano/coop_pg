...
SELECT       -- NOTE: the dots join values FROM the forum_topics and forum_messages tables
    ...
    '[Discussion](/c_workspaces/workforum_message_display_4.sql?topic_id='||t.topic_id||'&workspace_id='||$workspace_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Close](/c_workspaces/workforum_topic_close_0.sql?topic_id='||t.topic_id||'&workspace_id='||$workspace_id||')'   AS View
