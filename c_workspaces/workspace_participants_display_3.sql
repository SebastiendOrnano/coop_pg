...
SELECT
    ...
    CASE 
    WHEN user_id = $user_id::INTEGER THEN ''
    ELSE    '[Chat](/c_workspaces/workchat_form1_3.sql?workspace_participant_id='||workspace_participant_id||'&workspace_id='||workspace_id||')' END AS View
