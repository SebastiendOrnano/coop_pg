...
--  TRUE                  AS striped_rows,
    TRUE                  AS small,
    TRUE                 AS search,
    '/c_workspaces/workspace_main_edit_4.sql?workspace_id={id}' as edit_url,
    '/c_workspaces/workspace_main_delete_alert_4.sql?workspace_id={id}' as delete_url;
    ...
    ELSE
      json_build_array(
        ...
        json_build_object(
          ...
          'link', '/c_workspaces/workspace_hub_display_4.sql?workspace_id='||s.workspace_id,
          'icon', 'login-2'
        ),
        json_build_object(
          'name', 'Quit',
