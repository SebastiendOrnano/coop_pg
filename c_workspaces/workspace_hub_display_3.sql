...
SELECT 'table' AS component, 
    ...
    'Alert'          AS markdown,
    '/c_workspaces/workmeeting_edit_3.sql?workmeeting_id={id}' as edit_url,
    JSON('{"name":"View - Register","tooltip":"Voir et s''inscrire à la réunion","link":"/c_workspaces/workmeeting_participants_display_3.sql?workmeeting_id={id}","icon":"binoculars"}') as custom_actions,
    TRUE             AS sort, 
    TRUE             AS small,
    TRUE             AS search;
