...
SELECT
   ...
   '[Edit](/a_process/process_step_edit_5.sql?process_step_id='||s.process_step_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Delete](/a_process/process_step_delete_0.sql?process_step_id='||s.process_step_id||')'    AS View
